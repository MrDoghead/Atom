...
QMODEL=/data/models/atom_omac3072_g16_real/llama-2-7b-hf_w4a4_wikitext2_fake4bit.pt
...
cmd_eval="--real_quant"
cmd_save="--save_dir /data/models/atom_omac3072_g16_real --load_qmodel ${QMODEL}"
cmd_text="--text_completion --temperature 0.6 --top_p 0.85 --max_seq_len 128 --max_gen_len 64"
