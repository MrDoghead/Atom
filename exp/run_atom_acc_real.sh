...
QMODEL=/data/models/atom_real/llama-2-7b-hf_w4a4_wikitext2.pt
...
cmd_eval="--eval_common_sense --lm_eval_limit -1 --multigpu --real_quant"
cmd_save="--save_dir /data/models/atom_real --load_qmodel ${QMODEL}"

dir=$(pwd)
resultFile=$dir/logs/atom_llama_ppl.csv

logFile=$dir/logs/atom_llama2_w${BIT}a${BIT}_acc.log
touch $logFile

CUDA_VISIBLE_DEVICE=1,2,3,4 python ${dir}/model/main.py ${MODEL} ${CALIB_DATA} \
