...
QMODEL=/data/models/atom_omac1024_real/llama-2-7b-hf_w4a4_wikitext2_fake4bit.pt
#QMODEL=/data/models/atom_omac1024_real/llama-2-7b-hf_w4a4_wikitext2.pt
...
CUDA_VISIBLE_DEVICES=0 python ${dir}/model/main.py ${MODEL} ${CALIB_DATA} \
