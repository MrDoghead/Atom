...
QMODEL=/data/models/atom_omac1024_g16_real/llama-2-7b-hf_w4a4_wikitext2_fake4bit.pt
#QMODEL=/data/models/atom_omac1024_g16_real/llama-2-7b-hf_w4a4_wikitext2.pt
...
cmd_save="--save_dir /data/models/atom_omac1024_g16_real --load_qmodel ${QMODEL}"
...
CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --standalone --nnodes=1 --nproc_per_node=4 ${dir}/model/main_dp.py ${MODEL} ${CALIB_DATA} \
