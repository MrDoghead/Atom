...
cmd_eval="--eval_common_sense --lm_eval_limit -1 --real_quant"
cmd_save="--save_dir /data/models/atom_omac2048_g16_real --load_qmodel ${QMODEL}"
# cmd_save="--save_dir /data/models/atom_omac2048_g16_real"
