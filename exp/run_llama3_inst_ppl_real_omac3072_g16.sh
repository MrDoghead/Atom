...
QMODEL=${SAVE_DIR}/meta-llama-3-8b_inst_w4a4_wikitext2_fake4bit.pt
...
dir=$(pwd)
resultFile=$dir/logs/atom_llama3_ppl.csv

logFile=$dir/logs/atom_llama3_w${BIT}a${BIT}_ppl.log
touch $logFile

CUDA_VISIBLE_DEVICES=3 python ${dir}/model/llama3.py ${MODEL} ${CALIB_DATA} \
